...
- Walletize server running (see [walletize-server](https://github.com/Walletize/server)) 🖥️
...
2. Create a `.env` file in the root directory with the following variables, and adjust them accordingly (or copy `.env.example`): ⚙️
   ```bash
